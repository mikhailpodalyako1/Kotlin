package com.gmail.kotlinhw23.servise
...
import com.gmail.kotlinhw23.view.*
...
class DetailsServise (name: String = "DetailsService") : IntentService(name){
    ...
    private fun onEmptyResponse() {
        putLoadResult(DETAILS_REPOSITORY_EMPTY_EXTRA)
        LocalBroadcastManager.getInstance(this).sendBroadcast(broadcastIntent)
    }
